...
import org.sayesaman.database.dao.GoalDao_;
    ...
    extends MyActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.bpp1);
    }

    private void init_(Bundle savedInstanceState) {
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        getWindow().setFlags(android.view.WindowManager.LayoutParams.FLAG_FULLSCREEN, android.view.WindowManager.LayoutParams.FLAG_FULLSCREEN);
        dao = GoalDao_.getInstance_(this);
    }

    private void afterSetContentView_() {
        bpp1_footer_records = ((TextView) findViewById(id.bpp1_footer_records));
        bpp1_footer_records_ = ((TextView) findViewById(id.bpp1_footer_records_));
        bpp1_footer_date1 = ((TextView) findViewById(id.bpp1_footer_date1));
        bpp1_footer_date2 = ((TextView) findViewById(id.bpp1_footer_date2));
        ((GoalDao_) dao).afterSetContentView_();
        after();
    }
