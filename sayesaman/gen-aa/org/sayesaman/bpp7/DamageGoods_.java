...
import org.sayesaman.database.dao.RetCauseDao_;

public final class DamageGoods_
    extends DamageGoods
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.bpp7_damage);
    }
    ...
    private void init_(Bundle savedInstanceState) {
        ...
        retCauseDao = RetCauseDao_.getInstance_(this);
    ...
    private void afterSetContentView_() {
        ...
        ((RetCauseDao_) retCauseDao).afterSetContentView_();
    ...
    public static DamageGoods_.IntentBuilder_ intent(Context context) {
        return new DamageGoods_.IntentBuilder_(context);
    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, DamageGoods_.class);
        }
        ...
        public DamageGoods_.IntentBuilder_ flags(int flags) {
