    ...
    extends MainActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.app6_activity_main);
    }

    private void init_(Bundle savedInstanceState) {
        dao = GoodsGroupDao_.getInstance_(this);
    }

    private void afterSetContentView_() {
        expandableListView = ((ExpandableListView) findViewById(id.expandableListView));
        ((GoodsGroupDao_) dao).afterSetContentView_();
        afterViews();
    }
