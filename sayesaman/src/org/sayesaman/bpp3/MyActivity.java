...
public class MyActivity extends Activity {
    ...
    protected void after() {
        ...
        OrderStatus orderStatusAll = orderDao.getOrderStatusAll();

        bpp3_footer1.setText(String.valueOf(list.size()));

        long x = list.size();
        long y = Long.parseLong(orderStatusAll.getOrder_qty());
        long z = 0;
        if (x != 0) z = (y / x);
        bpp3_footer2.setText("("+"میانگین خط فاکتور : "+ String.valueOf(z) +")");

        bpp3_footer3.setText(Statics.commas.insertCommas(orderStatusAll.getOrder_qty()));
        bpp3_footer4.setText(Statics.commas.insertCommas(orderStatusAll.getOrder_sum()));
        bpp3_footer5.setText(Statics.commas.insertCommas(orderStatusAll.getOrder_price()));
    ...
    private View getNewView(int i) {
        ...
        TextView bpp3_order_qty = (TextView) view.findViewById(R.id.bpp3_itm_qty);
        TextView bpp3_order_sum = (TextView) view.findViewById(R.id.bpp3_itm_sum);
        TextView bpp3_order_price = (TextView) view.findViewById(R.id.bpp3_itm_price);
        ...
        bpp3_order_qty.setText(cust.getOrderStatus().getOrder_qty());
        bpp3_order_sum.setText(cust.getOrderStatus().getOrder_sum());
        String orderPrice = cust.getOrderStatus().getOrder_price();
        bpp3_order_price.setText(Statics.commas.insertCommas(orderPrice));

        try {
            if (Double.parseDouble(orderPrice) <= Double.parseDouble(minPriceSale))
                bpp3_order_price.setTextColor(Statics.getColorError());
        ...
        bpp3_image_cust.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (parent != null) {
                    ...
                    OrderHdr orderHdr2 = orderDao.getOneOrderWithItemsById(id);

                    CustomerDialog dialog = new CustomerDialog(view.getContext(), orderHdr2.getCustomer());
