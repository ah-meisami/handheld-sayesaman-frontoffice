package org.sayesaman.tut7.sakhtemankala.scrollview.two.way;
/*
 ...
 * is a {@link FrameLayout}, meaning you should place tut8_divider child in it
...
public class TwoDScrollView extends FrameLayout {
    ...
    public void addView(View child) {
        if (getChildCount() > 0) {
            throw new IllegalStateException("TwoDScrollView can host only tut8_divider direct child");
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_DOWN && ev.getEdgeFlags() != 0) {
            // Don't handle edge touches immediately -- they may actually belong to tut8_divider of our
            // descendants.
            return false;
        }
