...
@NoTitle
@Fullscreen
public class DamageSubGroup extends Activity {
    ...
    private void configHeaderTitle() {
        bpp7_header2.setText("گروه فرعی کالا");

        if (formType.equals("order")) {
            bpp7_header_title.setText("درخواست : " + groupName1 + " : ");
        } else {
            bpp7_header_title.setText("ضایعات : " + groupName1 + " : ");
        }
    }
    ...
    private View getNewView(int i) {
        ...
        DamageStatus status = damageDao.getDamageStatusByIdAndMainGoodsGroupAndSubGoodsGroup(formId, groupId1 , group.getId());
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent();
                i.setClass(getApplicationContext(), DamageGoods_.class);
    ...
    private void fillFooter() {
        DamageStatus status = damageDao.getDamageStatusByIdAndMainGoodsGroup(formId, groupId1);
        String countGoods = goodsGroupDao.getCountGoods4NewDamageByMainGoodsGroup(groupId1);
