 ...
 */
public class AdvancedMapViewer extends MapActivity implements OnClickListener {
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn_show_my_location).setOnClickListener(this);
	}
	...
	ArrayItemizedOverlay myitemizedOverlay;
	OverlayItem myoverlayItem;

	@Override
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.btn_show_my_location:
				if (myitemizedOverlay == null) {
					myitemizedOverlay = new ArrayItemizedOverlay(null);
					myoverlayItem = new OverlayItem();
					myoverlayItem.setMarker(ItemizedOverlay.boundCenter(getResources().getDrawable(R.drawable.mozomo)));
					myoverlayItem.setPoint(new GeoPoint(35.75648622023752, 51.44857428967953));
					myitemizedOverlay.addItem(myoverlayItem);
					mapView.getOverlays().add(myitemizedOverlay);
					mapController.setCenter(new GeoPoint(35.75648622023752, 51.44857428967953));
					((Button) findViewById(R.id.btn_show_my_location)).setText("hide location");
				} else {
					mapView.getOverlays().remove(myitemizedOverlay);
					myitemizedOverlay = null;
					((Button) findViewById(R.id.btn_show_my_location)).setText("show location");
				}
				break;
