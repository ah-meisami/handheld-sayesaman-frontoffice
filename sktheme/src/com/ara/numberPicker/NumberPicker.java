...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++) {
			if (attrs.getAttributeName(i).compareToIgnoreCase("start_num") == 0) {
				mStart = Integer.parseInt(attrs.getAttributeValue(i));
			}
			if (attrs.getAttributeName(i).compareToIgnoreCase("end_num") == 0) {
				mEnd = Integer.parseInt(attrs.getAttributeValue(i));
			}
			if (attrs.getAttributeName(i).compareToIgnoreCase("value") == 0) {
				str=(attrs.getAttributeValue(i));
			}
			if (attrs.getAttributeName(i).compareToIgnoreCase("digit_num") == 0) {
				digitnums=Integer.parseInt((attrs.getAttributeValue(i)));
			}
		}
        if(digitnums==2)
        ...
        if(str!=null){
        mText.setText(formatNumber(Integer.parseInt(str)));
        mCurrent=Integer.parseInt(str);
        }
        if (!isEnabled()) {
            setEnabled(false);
        }
